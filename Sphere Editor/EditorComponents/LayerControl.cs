...
namespace Sphere_Editor.EditorComponents
{
    ...
    public class LayerItem : IDisposable
    {
        ...
        public void PaintItem(Graphics g, int x, int y, int width)
        {
            ...
            if (Visible)
                g.DrawImage(Sphere_Editor.Properties.Resources.eye, bounds.X + 2, bounds.Y + 2, 16, 16);
            else
                g.DrawImage(Sphere_Editor.Properties.Resources.eye_shut, bounds.X + 2, bounds.Y + 2, 16, 16);
